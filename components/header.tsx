...
const products = [
  ...
  { name: 'Engagement', description: 'Speak directly to your customers', href: '/dashboard/product', icon: CursorArrowRaysIcon },
...
export default function Header() {
  ...
  return (
    <header className="bg-gray-900 sticky top-0 z-50 shadow border border-gray-800">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          <a href="/toast-demo" className="text-sm/6 font-semibold text-white">
            Features
          </a>
          <a href="/subscribe" className="text-sm/6 font-semibold text-white">
            Marketplace
          </a>
          <a href="/company" className="text-sm/6 font-semibold text-white">
            Company
          </a>
          <a href="/editor" className="text-sm/6 font-semibold text-white">
            Editor
          </a>
        </PopoverGroup>
